...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.85\linewidth]{images/ex_1_a_alpha_stable_vector_simulation_symmetric_discreet_scatter.png}
	...
	For discrite case with parameters mentioned above, we simulated independent $\alpha$-stable vector.
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.95\linewidth]{images/ex_1_b_alpha_stable_vector_simulation_symmetric_continous_scatter}
	...
	For generated vectors, we calculated following covariance of marginals of vector, which is equal to -$0.02$. It is really close to zero, so we can assume, that we sucessfully generated independent case.
